...
import { PriceOracle } from '../types/bdbETH/PriceOracle'
// PriceOracle2 is valid from 8498422 until present block (until another proxy upgrade)
import { CToken } from '../types/bdbETH/CToken'
import { ERC20 } from '../types/bdbETH/ERC20'
import { PriceOracle2 } from '../types/bdbETH/PriceOracle2'
...
function getTokenPrice(
  ...
  let priceOracle1Address = Address.fromString(
    '0xbCb0a842aF60c6F09827F34841d3A8770995c6e0',
  )
...
export function updateMarket(
  ...
  if (market.accrualBlockNumber != blockNumber) {
    ...
    let usdPriceInEth = getUSDpriceETH(blockNumber)

    // if cETH, we only update USD price
    if (marketID == cETHAddress) {
